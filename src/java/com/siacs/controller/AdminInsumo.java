...
public class AdminInsumo extends HttpServlet {
...
//                    break;
    ...
    private void nuevo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("vistaSIACS/registrar.jsp");
        dispatcher.forward(request, response);
    }
    ...
    private void registrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        Insumo articulo = new Insumo(0, request.getParameter("codigo"), request.getParameter("nombre"),
...
//		Articulo articulo = insumoDAO.obtenerPorId(Integer.parseInt(request.getParameter("id")));
...
//		insumoDAO.actualizar(articulo);
//		index(request, response);
//	}
//	
//	private void eliminar(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
//		Articulo articulo = insumoDAO.obtenerPorId(Integer.parseInt(request.getParameter("id")));
//		insumoDAO.eliminar(articulo);
//		RequestDispatcher dispatcher = request.getRequestDispatcher("index.jsp");
//		dispatcher.forward(request, response);
//		
//	}
